...
export function JobTargeting() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log('[CV-GENERATOR] 📤 Complete payload being sent directly to Make:', JSON.stringify(payload, null, 2));

      // Fire & forget – direct to Make webhook (bypasses Edge Function env var issue)
      const makeWebhookUrl = 'https://hook.eu2.make.com/tgu7hpllgy3nyslrp2qf5fcjsc06vkuq';
      fetch(makeWebhookUrl, {
        ...
        .then((res) => {
          console.log('[CV-GENERATOR] Make webhook response:', res.status);
        })
        .catch((err) => {
          console.error('[CV-GENERATOR] Make webhook error:', err);
        });
