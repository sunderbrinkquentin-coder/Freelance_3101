...
interface AgentEntryAddFormProps {
  sectionId: string;
  onSave: (newEntry: any) => void;
  onCancel: () => void;
}

export default function AgentEntryAddForm({
  sectionId,
  onSave,
  onCancel,
}: AgentEntryAddFormProps) {
  ...
  return (
    <motion.div
      ...
      className="bg-white bg-opacity-5 rounded-lg p-4 border-2 border-primary mb-2"
    >
